...
// MQTT pub // sub
// PUBLISH TOPIC
let myPublishTopic = "sd_motorControl";
let mySubscribeTopic = "motorPosition";
let payload = "empty";
...
function setup() {
  ...
  localVideo = createCapture(constraints, 
    function(stream) {
      let p5lm = new p5LiveMedia(this, "CAPTURE", stream, "shareWindow");  // my name - special number jZQ64AMJc 
