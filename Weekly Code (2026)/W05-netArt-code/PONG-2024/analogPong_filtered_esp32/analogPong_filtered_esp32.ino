...
void readSensors(){
  ...
  Serial.print(myPosition);  // debug for plotter
  Serial.print("\t");

    theFilter.in(myPosition);
    myPosition = theFilter.out();

  Serial.print(myPosition);  // plotter again 
  Serial.print("\t");
...
void calculatePosition(){
  ...
  myPosition = map ( myPosition, 525,650,0,255);
  Serial.print(myPosition);  // debug for plotter
  Serial.print("\t");
