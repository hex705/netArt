...
void scissorsEvent( String &theMessage ){  // its just a string
   ...
   digitalWrite(builtIn,0);
    ...
    inX = scissors.getInt(0);   // receiving one number from 0-255
    inY = scissors.getInt(1);
    ...
    String xString = "mouseX::  ";
    xString+=inX;
    showText(xString, 5, 5, 1);  // clear screen then print .. a bit weird, sorry

    String yString = "mouseY::  ";
    yString+=inY;
    showText(yString, 5, 15, 0);
