...
function onMqttMessageArrived(message) {
 ...
 // get the topic of the current message
  ...
  console.log("got "+theTopic+" : " +incomingPayload);
  ...
  switch (theTopic) {
    case SUBscribeTopicRed:  // note this topic must match 
     // console.log("IN: onMqttMessageArrived, got a TopicOne message");
      subscribeRed = scissors.getInt(0);
      break;
    case SUBscribeTopicGreen:
      // console.log("IN: onMqttMessageArrived, got a TopicTwo message  " );
      subscribeGreen = scissors.getInt(0);
      break;
    case SUBscribeTopicBlue:
      // console.log("IN: onMqttMessageArrived, got a TopicTwo message  " );
      subscribeBlue = scissors.getInt(0);
      break;
    default:
      //  do nothing
  }
