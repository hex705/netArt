// this example uses library from Kevin Harrington
...
/* Servo Sweep
 ...
 modified mar2022, control 3 servos (needs large current external power supply. 
 ...
 * The published min and max for this snervo is 1000 and 2000, respectively, so the defaults are fine.
 * These values actually drive the servos a little past 0 and 180, so
 * if you are particular, adjust the min and max values to match your needs.
 */

// Recommended PWM GPIO pins on the ESP32 include 2,4,12-19,21-23,25-27,32-33
// huzzah32 -- cannot use D05, A02, A03, A04  - all others should be good (not tested)
...
void setup() {
  ...
  // using default min/max of 1000us and 2000us
	myservoGreen.attach(servoPinGreen, 500, 3000);
