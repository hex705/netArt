...
// simplify this
  ...
  // ok if a playerTwo message arrivesi n p1 game ERROR
//  console.log(" how many players ? " + p.playersCount );
  ...
  if  ((STATE == AWAIT_PLAYERS) ||(STATE == SKILL_LEVEL) ||(STATE == SERVE ) || (STATE == RALLY )){
  switch (theTopic) {
