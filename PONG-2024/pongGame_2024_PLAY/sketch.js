...
// these are RESERVED -- ONLY CURRENT PLAYERS USE THESE PLEASE!
 ...
 let subscribeToPlayerOne = "AngelPongPaddle"; // playerOne = left side
 let subscribeToPlayerTwo = "p6"; // playerTwo = right side
...
//let subscribeToPlayerOne = "steveAnalogPaddle"; // playerOne = left side
//let subscribeToPlayerTwo = "steveAccelPaddle"; // playerTwo = right side
//**************************************************
...
let screenBorderX = 500;
let screenBorderY = 120;
...
function setup() {
  ...
  theCanvas = createCanvas(windowWidth-screenBorderX , windowHeight-screenBorderY ); // was 500, 250
  //console.log(windowWidth +"  "+ windowHeight);
  theCanvas.position(175,60);
...
function windowResized() {
  resizeCanvas(windowWidth-screenBorderX , windowHeight-screenBorderY);
}
...
function playerConnect( _s, _name, _index ) {
  ...
  if ( !p.players[playerIndex].getConnectionStatus()) { // should only execute if never connected before
