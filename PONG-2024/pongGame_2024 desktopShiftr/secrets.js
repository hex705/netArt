...
let URL_FROM_INSTANCE = 'localhost'; // "your-URL-from-token"

let DEVICE_NAME_IN_QUOTES    = 'steve-PONG-2024';
let INSTANCE_OR_USER_NAME    = 'netart-pong-2024'; //'INSTANCE-NAME-HERE'
let CHECK_DtwoL_FOR_MQTT_KEY = 'nwQyy502OPS5HCps';  // 'REPLACE-WITH-KEY-from-token'
